# ChestXRay-Analysis
This repository consists  of the research project on Pneumonia Detection using Chest X-Ray Analysis by Shuvam Aich, Rashmiman Nandi and Anjishnu Roy, Semester 6, Department of Computer Science, St. Xavier's College, Kolkata
